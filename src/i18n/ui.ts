...
export const ui = {
  en: {
    meta: {
      title: "Maximillian Leonard - Software Developer, Kuala Lumpur",
      description:
      ...
      aboutTitle: "About - Maximillian Leonard",
      contactTitle: "Contact - Maximillian Leonard",
      projectsTitle: "Projects - Maximillian Leonard",
    },
    common: {
      page: "Page",
      of: "of",
    ...
    contact: {
      ...
      methods: {
        ...
        email: {
          method: "Email",
          value: "hello@maximillianleonard.dev",
          description: "Best for project inquiries and collaboration",
          response: "< 24 hours",
        },
        linkedin: {
          method: "LinkedIn",
          value: "/in/maximillianleonard1508",
          description: "Professional networking and career discussions",
          response: "< 48 hours",
        },
        github: {
          method: "GitHub",
          value: "/maximillian1508",
          description: "Code reviews, open source contributions",
          response: "varies",
        },
      },
      projectTypes: {
    ...
    projects: {
      ...
      cta: {
        interested: "interested in similar results for your project?",
  ...
  id: {
    meta: {
      ...
      aboutTitle: "Tentang - Maximillian Leonard",
      contactTitle: "Kontak - Maximillian Leonard",
      projectsTitle: "Proyek - Maximillian Leonard",
    },
    common: {
      page: "Halaman",
      of: "dari",
    ...
    about: {
      ...
      cta: {
        ...
        discuss: "ayo diskusikan proyek Anda →",
      },
    },
    contact: {
      title: "mari",
      ...
      methods: {
        ...
        email: {
          method: "Email",
          value: "hello@maximillianleonard.dev",
          description: "Terbaik untuk pertanyaan proyek dan kolaborasi",
          response: "< 24 jam",
        },
        linkedin: {
          method: "LinkedIn",
          value: "/in/maximillianleonard1508",
          description: "Jaringan profesional dan diskusi karir",
          response: "< 48 jam",
        },
        github: {
          method: "GitHub",
          value: "/maximillian1508",
          description: "Code review, kontribusi open source",
          response: "bervariasi",
        },
      },
      projectTypes: {
        ...
        landingPage: "Landing Page",
        performanceOptimization: "Optimisasi Kinerja",
        technicalSEO: "Technical SEO",
      },
      availability: {
        title: "Ketersediaan",
      ...
      cta: {
        ready: "siap memulai proyek Anda?",
    ...
    projects: {
      ...
      cta: {
        interested: "tertarik dengan hasil serupa untuk proyek Anda?",
        discuss: "ayo diskusikan kebutuhan Anda →",
      },
    },
  },
} as const;
